...
logging.basicConfig(filename="logData.txt", level=logging.WARNING, 
...
def getReqRate(app1, app2):
    ...
    if 'data' in reply1 and 'result' in reply1['data']:
        ...
        if valid_data_cnt > 1:
            print("GOT MORE THAN ONE VALID DATA!!! ")
            logging.warning("more than one valid data"+ str(reply1['data']['result']))
...
def getResRate(app1, app2):
    ...
    if 'data' in reply1 and 'result' in reply1['data']:
        ...
        if valid_data_cnt > 1:
            print("GOT MORE THAN ONE VALID DATA!!! ")
            logging.warning("more than one valid data", str(reply1))
...
while True:
    # updateRate()
    # sleep(60)
    # getReqRate("recommendationservice", "productcatalogservice")
