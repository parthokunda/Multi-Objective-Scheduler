...
for i, user in enumerate(USERS):
    ...
    ax.text(barMOS[0].get_x() + barMOS[0].get_width() / 2, barMOS[0].get_height() , f'{(sameNetRequests[0]/1000):.1f}K ', rotation='vertical', ha='center', va='top', color='white', fontsize=18, fontweight='bold')
...
plt.tight_layout()
plt.savefig(f'thesis_plots/images/Rt_Baseline.png', dpi=1200, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(f'thesis_plots/images/C_Baseline.png', dpi=1200, bbox_inches='tight')