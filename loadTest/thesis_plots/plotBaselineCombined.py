...
for i, user in enumerate(USERS):
    ...
    barMOS = ax.bar(index[i] + 3 * bar_width, sameNetRequests, bar_width, label=f'MOS', color=palette[0])
    ...
    if i == 0:
        legend_entries = [bardefault, barNetMarks, barBinPack, barMOS]
...
plt.tight_layout()
plt.savefig(f'thesis_plots/images/Rt_C_Baseline.png', dpi=1200, bbox_inches='tight')
